    ...
    <div className='h-[200vh]'>
      <div className=' h-screen content-center bg-hero-pattern justify-items-center sticky top-0 overflow-hidden'>
        ...
        <motion.a
          initial={{ opacity: 0, scale: 1 }}
          animate={{ opacity: 1, scale: 1 }}
          className='md:text-5xl text-3xl font-bold bg-[#052829] p-4 rounded-2xl inline-block w-fit mx-auto text-center'
        ...
        <motion.a
          initial={{ opacity: 0, scale: 1 }}
          animate={{ opacity: 1, scale: 1 }}
          className='md:text-3xl text-2xl font-extrabold underline rounded-2xl inline-block w-fit mx-auto'
          href='/resume.pdf'
          target='_blank'
        >
          Download resume (PDF)
